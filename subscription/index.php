                                    ...
                                    if ($plans->num_rows > 0) {
                                        ...
                                        while ($row = $plans->fetch_assoc()) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<?php echo BASE_URL ?>subscription?action=edit&id=<?php echo $row['id'] ?>" class="btn btn-primary btn-sm">
                                                        Edit
                                                    </a>
                                                    <a onclick="return confirm('Do you want to delete this?')" href="<?php echo BASE_URL ?>subscription?action=delete&id=<?php echo $row['id'] ?>" class="btn btn-danger btn-sm">
                                                        Delete
                                                    </a>

                                                    <?php if ($row['status'] == 1) { ?>
                                                        <a href="<?php echo BASE_URL ?>subscription?action=status&id=<?php echo $row['id'] ?>&status=0" class="btn btn-warning btn-sm">
                                                            Inactive
                                                        </a>
                                                    <?php }
                                                if ($row['status'] == 0) {  ?>

                                                        <a href="<?php echo BASE_URL ?>subscription?action=status&id=<?php echo $row['id'] ?>&status=1" class="btn btn-success btn-sm">
                                                            Active
                                                        </a>
                                                    <?php } ?>
                                                </td>
                        ...
                        <form method="post" action="<?php echo BASE_URL ?>subscription/index.php">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <?php } else  ?>
                                    <a href = "<?php echo BASE_URL ?>subscription"  class="btn btn-secondary">
                                        Cancel
                                           </a>
                                           </php  ?>
                                </div>
